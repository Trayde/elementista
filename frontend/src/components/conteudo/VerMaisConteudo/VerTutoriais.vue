...
export default {
  ...
  methods: {
    ...
    downloadFile() {
      // console.log("this.content.fileName", this.content.fileName);
      // console.log("his.content.documento", this.content.documento);
      // if (this.content.fileName != undefined) {
      ...
      // } else if (this.content.documento) {
