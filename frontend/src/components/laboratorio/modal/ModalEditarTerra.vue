        ...
        <div class="col-md-10 grid-margin">
            <div class="row">
                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                    <h3 class="font-weight-bold white">Editar Terra</h3>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        async show() {
            ...
            const response = await ApiMethodsAtividades.obterTerraId(id)
            response.map((dados) => {
                this.content = {
        ...
        salvar() {
            ...
            ApiMethodsAtividades.editarTerra(dados).then((res) => {
                if (res.data === 'sucesso') {
